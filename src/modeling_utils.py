...
class PreTrainedModel(MetaModule, ModuleUtilsMixin, GenerationMixin, PushToHubMixin):
    r"""
    ...
    def _tie_encoder_decoder_weights(encoder: nn.Module, decoder: nn.Module, base_model_prefix: str):
        ...
        def tie_encoder_to_decoder_recursively(
            decoder_pointer: MetaModule,
            encoder_pointer: MetaModule,
            module_name: str,
            uninitialized_encoder_weights: List[str],
            depth=0,
        ):
            assert isinstance(decoder_pointer, MetaModule) and isinstance(
                encoder_pointer, MetaModule
    ...
    def _get_resized_lm_head(
        ...
        new_lm_head = MetaLinear(*new_lm_head_shape, bias=has_new_lm_head_bias).to(self.device)
